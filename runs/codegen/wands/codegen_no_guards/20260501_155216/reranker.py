def rerank_wands(*args, **kwargs):
    ...
    k_rrf = 60
    w_title_or = 1.15
    w_title_and = 2.0 if has_dims else (1.7 if {'black','white','gray','grey','blue','navy','red','green','pink','purple','gold','silver','bronze','brass','brown','beige','ivory','charcoal','champagne','turquoise','teal'} & q_terms_set else 1.55)
    w_desc_or = 0.9
    w_desc_and = 1.0
    w_var_title_and = 1.65 if has_dims else (1.4 if {'black','white','gray','grey','blue','navy','red','green','pink','purple','gold','silver','bronze','brass','brown','beige','ivory','charcoal','champagne','turquoise','teal'} & q_terms_set else 1.2)
    w_var_title_or = 0.6
