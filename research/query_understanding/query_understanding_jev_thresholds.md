...
![Choice classifier mean recall versus coverage](../../assets/query_understanding_jev_thresholds.png)

The table below is from [`research/results/query_understanding_jev_thresholds.csv`](../results/query_understanding_jev_thresholds.csv). Recall and coverage are fractions, rounded to four decimal places.
