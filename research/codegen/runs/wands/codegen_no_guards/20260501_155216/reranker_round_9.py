def rerank_wands(*args, **kwargs):
    ...
    for did in candidate_ids:
        ...
        if title:
            ...
            if q_content_terms:
                color_terms_cov = {"black","white","gray","grey","blue","navy","red","green","pink","purple","gold","silver","bronze","brass","brown","beige","ivory","charcoal","champagne"}
        ...
        # Color matches with synonym support (no penalty when missing)
        if q_colors:
